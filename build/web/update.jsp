    ...
    <body>
        ...
        <div class="container">
            <div class="card text-center mt-5">    
                ...
                <h5 class="card-title pt-5">Dados pessoais</h5>
                <p>Atualize seus dados</p>
                <article>
                <form class="card-body mx-auto row" id="formulario_aluno" method="POST" action="http://localhost:8084/LeroLeroCursos/update">
                  ...
                  <div class="form-group input-group col-12">
                    ...
                    <input class="form-control" id="nome" name="nome" placeholder="Nome completo*" type="text" value="<%=aluno.getNome()%>">
                  </div>      
                  ...
                  <div class="form-group input-group col-6">
                    ...
                    <input class="form-control" id="cpf" name="cpf" placeholder="CPF*" type="text" id="cpf" value="<%=aluno.getCpf()%>">
                  </div>
                  ...
                  <div class="form-group input-group col-6">
                    ...
                    <input class="form-control" id="email" name="email" placeholder="Endereço de email*" type="email" value="<%=aluno.getEmail()%>">
                  </div>
                  ...
                  <div class="form-group input-group col-4">
                    ...
                    <input class="form-control" id="celular" name="celular" placeholder="Celular*" type="tel" value="<%=aluno.getCelular()%>">
                  </div>
                  ...
                  <div class="form-group input-group col-4">
                    ...
                    <input class="form-control" id="cidade" name="cidade" placeholder="Cidade" type="text" value="<%=aluno.getCidade()%>">
                  </div>
                  ...
                  <div class="form-group input-group col-4">
                    ...
                    <input class="form-control" id="cep" name="cep" placeholder="CEP" type="text" value="<%=aluno.getCep()%>">
                  </div>
                  ...
                  <div class="form-group input-group col-4">
                    ...
                    <input class="form-control" id="bairro" name="bairro" placeholder="Bairro" type="text" value="<%=aluno.getBairro()%>">
                  </div>
                  ...
                  <div class="form-group input-group col-8">
                    ...
                    <input class="form-control" id="endereco" name="endereco" placeholder="Endereço" type="text" value="<%=aluno.getEndereco()%>">
                  </div>
                  ...
                  <div class="form-group input-group col-4">
                    ...
                    <input class="form-control" id="login" name="login" placeholder="Login*" type="text" value="<%=aluno.getLogin()%>">
                  </div>
