      ...
      <jsp:include page="templates/navbar.jsp"/>
        ...
        <div class="container">
            <div class="card text-center mt-5">
                ...
                <h5 class="card-title pt-5">Matricule-se</h5>
                <form class="card-body mx-auto row" id="formulario_matricula" method="POST" action="http://localhost:8084/LeroLeroCursos/enroll">
                  ...
                  <div class="form-group input-group col-6">
                    ...
                    <select class="form-control" name="turmas_id">
